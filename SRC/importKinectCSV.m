function MoCap = importKinectCSV(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MOCAP = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   MOCAP = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   MoCap = importfile('MoCap.csv', 3, 360);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/10/30 15:47:48
